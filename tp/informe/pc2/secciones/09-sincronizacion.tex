...
\centering
\small
\input{secciones/figuras/workerpool-pc2}
\end{figure}
...
\input{generado/tabla-inercias}

La Tabla~\ref{tab:inercias} lo confirma sobre el dataset completo: la inercia final concurrente es
la misma para $P = 1, 2, 4, 8$ y $16$, en la laptop y en la máquina virtual. Frente a la secuencial la
