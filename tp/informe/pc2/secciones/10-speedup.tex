...
Las corridas oficiales se hicieron en una máquina virtual del equipo sobre Proxmox
(\texttt{\cifra{maquina}}), con \cifra{cpus-gorgo}~vCPU de un AMD Ryzen~5 7600X de 6 núcleos
físicos y 12 hilos, y 9~GB de RAM, ociosa durante la medición; el benchmark completo tomó
...
\input{generado/tabla-speedup-fuerte}
...
Y con $P = 16$ sobre \cifra{cpus-gorgo}~vCPU el speedup todavía sube un poco
...
sobresuscripción sobre 6 núcleos físicos.

\subsection{El mismo resultado hasta convergencia}

\input{generado/tabla-speedup-convergencia}
...
\input{generado/tabla-speedup-tamano}
