...
implementará en PC2 en Go, sin librerías de terceros, con goroutines y \texttt{sync.WaitGroup}, más una variante con
\texttt{sync.Mutex} para medir el costo de la contención.
