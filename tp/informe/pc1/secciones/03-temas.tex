...
\tarjeta{bellavita2025}{Popcorn, Kernel K-means en GPU}{
  ...
  opinion={El 123,8x me parece parcialmente engañoso: compara una A100 contra MATLAB de un solo hilo,
    ...
    cerca de los 60.000 puntos, y con una prueba rápida en la GPU de gorgo. La idea es mostrar que
...
la GPU, así que la ley de Amdahl \parencite{amdahl1967} no lo frena; lo frena la memoria, porque la
...
y choca con la memoria; el otro cambia el algoritmo para no chocar y choca con Amdahl. Nuestro Lloyd
exacto no tiene ninguno de los dos problemas de memoria: su límite será la fracción serial y la
