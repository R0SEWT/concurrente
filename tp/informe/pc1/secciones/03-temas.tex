...
\tarjeta{bellavita2025}{Popcorn, Kernel K-means en GPU}{
  ...
  opinion={El 123,8x me parece parcialmente engañoso: compara una A100 contra MATLAB de un solo hilo,
    ...
    a un proveedor. Me gustaría medirlo con submuestras de nuestros viajes, para mostrar que más
    paralelismo baja el tiempo pero no la memoria, y que la salida pasa por repartir la matriz entre
    varias GPU, como proponen \textcite{bellavita2026}.},
}
