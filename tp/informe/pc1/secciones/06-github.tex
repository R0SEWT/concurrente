...
\#4 & \nombreDayana & Propuesta de caso: NYC TLC y ODS 11 & En revisión \\
\#5 & \nombreRody & Issue de investigación bibliográfica & Abierta \\
\#6 & \nombreRody & Limpieza del dataset & Fusionada \\
\#7 & \nombreDayana & Análisis exploratorio (notebook) & En revisión \\
\#8 & \nombreRody & Bibliografía en BibTeX & En revisión \\
\#9 & \nombreRody & CI: notebooks sin salidas & En revisión \\
\#16 & \nombreRody & Informe de PC1 en LaTeX & En revisión \\
\bottomrule
\end{tabularx}
\end{table}

\pendiente{actualizar el estado de las PR al momento de la entrega y fusionar \texttt{develop} en
\texttt{main} con el tag \texttt{pc1}}
...
\pendiente{que el tercer integrante tenga commits propios: la rúbrica exige la participación de
todos}
